...
// Xử lý cache-busting an toàn cho CSS
...
<head>
    ...
    <!-- CSS chính + cache-busting -->
    <link rel="stylesheet" href="style.css?v=<?php echo $css_version; ?>">

    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">

    <!-- Bootstrap Icons (fix icon không hiển thị) -->
    <link rel="stylesheet"
          href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.1/font/bootstrap-icons.css">
</head>
<body>

<!-- TOPBAR (di chuyển ra ngoài site-header để tách biệt phần trên cùng) -->
<div class="topbar">
...
<header class="site-header">
    ...
    <!-- SEARCH BAR (giữ nguyên để flex cùng hàng với navbar) -->
