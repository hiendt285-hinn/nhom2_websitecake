                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td class="admin-action-cell">
                                ...
                                <a href="admin_dashboard.php?page=sizes&delete_id=<?php echo $row['id']; ?>" class="admin-btn admin-btn-danger admin-icon-btn admin-tooltip" data-tooltip="Xóa" style="text-decoration:none;" onclick="return confirm('Bạn có chắc muốn xóa <?php echo htmlspecialchars($row['name'], ENT_QUOTES); ?>?');"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
