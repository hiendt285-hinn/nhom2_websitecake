...
<div class="header" style="background:#5a8b56; color: #ff5f9e; padding:10px 30px; font-size: 20px; font-weight: bold; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1); border-radius: 0 0 25px 25px; position:relative;">
    ...
    <a href="admin_dashboard.php" style="color: #ff5f9e; text-decoration: none; font-weight: 600; transition: 0.3s;font-family: 'Poppins', sans-serif;">Trang chủ</a> 
    <span style="float:right; font-weight:normal;">
        <a href="logout_admin.php" style="color: #ff5f9e; text-decoration: none; font-weight: 600; transition: 0.3s;font-family: 'Poppins', sans-serif;">Đăng xuất</a>
    </span>
</div>